...
public:
    Prey(Vec2 x0, Vec2 v0, double max_speed = 1.0, double separation_coeff = 1.0);
    ...
    double sepCoeff;
    double separation_coeff;
    const double alignment_coeff = 1.0;
    const double cohesion_coeff = 1.0;
